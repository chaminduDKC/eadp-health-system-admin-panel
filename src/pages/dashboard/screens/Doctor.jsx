    ...
    return(
        <div className={sideBarVisible ? "collapsed" : "expanded"}>
           <div className="inner doctor">
               <Box sx={{backgroundColor:"var(--bg-primary)"}} mx="auto" maxWidth={800}  mt={5} p={3} border="1px solid var(--accent-color)" borderRadius={2}>
            ...
            <div className="doc-details">
                <Button color="success" sx={{marginTop:"20px", marginLeft:"40px"}} onClick={()=> getAllDoctors()} variant="contained">Load all doctors</Button>
                <Box sx={{
                    marginLeft:"40px",
                    marginTop:"20px"
                }}>
